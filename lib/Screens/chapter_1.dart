...
class Chapter1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TextStyle verseRefBody =
        new TextStyle(color: Colors.yellow, fontSize: 9, height: 1.5);
        ...
        child: Padding(
          ...
          child: SafeArea(
            child: Column(children: [
              ...
              Row(
                children: <Widget>[
                  BibleVerse.button(context, "2 Timothy 3:15-17"),
                  BibleVerse.button(context, "Isaiah 8:20"),
                  BibleVerse.button(context, "Luke 16:29"),
                ],
              ),
            ]),
          ),
